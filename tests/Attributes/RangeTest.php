...
class RangeTest extends TestCase
{
    public function testAcceptsValueInsideRange(): void
    {
        ...
        $this->assertTrue($validator->validate(3, $this->context));
    }
    ...
    public function testRejectsValueOutsideRange(): void
    {
        ...
        $this->assertFalse($validator->validate(8, $this->context));
    ...
    public function testTreatsNullAsValid(): void
    {
        ...
        $this->assertTrue($validator->validate(null, $this->context));
    }
